...
void WalletController::closeWallet(WalletModel* wallet_model, QWidget* parent)
{
    ...
    box.setWindowTitle(tr("Close account"));
...
ImportWalletActivity::ImportWalletActivity(WalletController* wallet_controller, QWidget* parent_widget)
    : WalletControllerActivity(wallet_controller, parent_widget)
{
}
...
void ImportWalletActivity::finish()
{
    ...
    if (!m_error_message.empty()) {
        QMessageBox::critical(m_parent_widget, tr("Import wallet failed"), QString::fromStdString(m_error_message));
    }
