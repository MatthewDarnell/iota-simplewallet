...
#include <forms/ui_askpassphrasedialog.h>
    ...
    m_passphrase_out(passphrase_out)
{
    ...
    switch(mode)
    {
        case Encrypt: // Ask passphrase x2
            ui->warningLabel->setText(tr("Enter the new passphrase for the account.<br/>Please use a passphrase of <b>ten or more random characters</b>, or <b>eight or more words</b>."));
            ui->passLabel1->hide();
            ui->passEdit1->hide();
        ...
        case ChangePass: // Ask old passphrase + new passphrase x2
            ...
            ui->warningLabel->setText(tr("Enter the old passphrase and new passphrase for the account."));
            break;
    }
    textChanged();
