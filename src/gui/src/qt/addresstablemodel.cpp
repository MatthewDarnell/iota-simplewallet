...
bool AddressTableModel::setData(const QModelIndex &index, const QVariant &value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        auto curAddress = rec->address.toStdString();
        if(index.column() == Label)
        {
            ...
            auto newAddress = value.toString().toStdString();
...
QString AddressTableModel::addRow(const QString &type, const QString &label, const QString &address)
{
    ...
    if(type == Send)
    {
        ...
        {
            if (walletModel->wallet().getAddress(strAddress, /* name= */ nullptr, /* is_mine= */ nullptr, /* purpose= */ nullptr))
            {
                editStatus = DUPLICATE_ADDRESS;
                return QString();
            }
        ...
        // Add entry
        walletModel->wallet().setAddressBook(strAddress, strLabel, "send");
    }
...
bool AddressTableModel::getAddressData(const QString &address,
    ...
    auto destination = address.toStdString();
