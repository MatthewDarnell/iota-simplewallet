    ...
    platformStyle(_platformStyle)
{
    ...
    //    connect(sendCoinsPage, &SendCoinsDialog::coinsSent, transactionView, static_cast<void (TransactionView::*)(const uint256&)>(&TransactionView::foq4AQ1cusTransaction));
...
void WalletView::backupWallet()
{
    ...
    bool backupResult = false;
    {
        ...
        if(ctx.isValid())
        {
            backupResult = walletModel->wallet().backupWallet(filename.toLocal8Bit().data());
        }
        else
        {
            return;
