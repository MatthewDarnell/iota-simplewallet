...
if (WIN32)
    ...
    ExternalProject_Add(iota.c-library
            ...
            UPDATE_COMMAND ""
            CMAKE_ARGS -DCMAKE_BUILD_TYPE="Debug" -DBUILD_SHARED_LIBS=OFF -DCMAKE_LINK_LIBRARY_FLAG=" ${CMAKE_LINK_LIBRARY_FLAG} -fPIC -lm wldap32 ws2_32 wsock32 crypt32" -DCMAKE_INSTALL_PREFIX=${DEPS_DIR}
            )
else ()
    ExternalProject_Add(iota.c-library
            GIT_REPOSITORY https://github.com/iotaledger/iota.c
            GIT_TAG e260967bd3a9088fa03d20c1517930e23f1de591
            CMAKE_ARGS -DCMAKE_BUILD_TYPE=Debug -DBUILD_SHARED_LIBS=OFF -DCMAKE_C_FLAGS=-fPIC -DCMAKE_INSTALL_PREFIX=${DEPS_DIR}
            )
endif()
